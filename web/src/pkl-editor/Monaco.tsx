...
// The inner component is created inside the lazy factory to avoid a
// circular reference.
const MonacoEditorInner = lazy(() =>
  import("monaco-editor").then((m) => ({
    default: function MonacoEditorImpl({
      language,
      value,
      onChange,
      options,
      ...
      useEffect(() => {
        ...
        const editor = m.editor.create(containerRef.current, {
          ...
          ...(options as m.editor.IStandaloneEditorConstructionOptions),
        });
